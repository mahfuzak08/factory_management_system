            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <form class="forms-sample" method="POST" action="{{ route('update-vendor', $vendor->id) }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="exampleInputName9" name="category">
                                          <option value="Fish" {{$vendor->category == "Fish" ? "selected" : ""}}>{{__('admin.Fish')}}</option>
                                          <option value="Chicken" {{$vendor->category == "Chicken" ? "selected" : ""}}>{{__('admin.Chicken')}}</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputName4" name="opening_balance" value="{{$vendor->opening_balance}}" placeholder="{{ __('admin.opening_balance') }}">
                                    </div>
