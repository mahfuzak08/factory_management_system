                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <div class="form-check submodule">
                                                    <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="module[]" {{in_array('Device', $modules) ? 'checked' : ''}} value="Device"> {{__('Device')}} <i class="input-helper"></i></label>
                                                </div>
                                                <div class="form-check submodule">
                                                    <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="module[]" {{in_array('Device_Add', $modules) ? 'checked' : ''}} value="Device_Add"> {{__('Device Add')}} <i class="input-helper"></i></label>
                                                </div>
                                                <div class="form-check submodule">
                                                    <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="module[]" {{in_array('Device_Delete', $modules) ? 'checked' : ''}} value="Device_Delete"> {{__('Device Delete')}} <i class="input-helper"></i></label>
                                                </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <div class="form-check">
