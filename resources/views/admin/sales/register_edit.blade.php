                      ...
                      <div class="card-body">
                        ...
                        <form action="{{route('save-sales')}}" method="POST" class="forms-sample table-responsive">
                          ...
                          <table class="table" style="min-width:500px">
                            <tr>
                              <td width="70%">
                                <input type="text" required name="customer_new" list="customer" id="customer_id" value="{{@$order[0]->customer_name}}" class="form-control" placeholder={{__('admin.customer_name')}}">
                                <input type="hidden" name="customer_id" value="{{@$order[0]->customer_id}}" id="customer_id_hidden">
                              ...
                              <td width="30%">
                                <input type="date" value="{{@$order[0]->date}}" required name="date" class="form-control" placeholder="YYYY-MM-DD" value="{{date('d-m-Y')}}">
                              </td>
                            </tr>
                            <tr>
                              <td width="70%">
