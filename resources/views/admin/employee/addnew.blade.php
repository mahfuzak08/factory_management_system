                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="forms-sample" method="POST" action="{{ route('save-employee') }}">
                                          ...
                                          <div class="col-sm-6">
                                            <div class="form-check">
                                              <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="gender" id="exampleInputName3" value="male" checked="true"> {{__('admin.male')}} <i class="input-helper"></i></label>
                                            </div>
                                          </div>
                                          <div class="col-sm-6">
                                            <div class="form-check">
                                              <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="gender" id="exampleInputName4" value="female"> {{__('admin.female')}} <i class="input-helper"></i></label>
                                            </div>
                                          </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputName6">{{ __('admin.address') }}</label>
                                        <input type="text" class="form-control" id="exampleInputName6" name="address" placeholder="{{ __('admin.address') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName7">{{ __('admin.nid') }}</label>
                                        <input type="text" class="form-control" id="exampleInputName7" name="nid" placeholder="{{ __('admin.nid') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName8">{{ __('admin.salary') }}</label>
                                        <input type="number" class="form-control" id="exampleInputName8" name="salary" placeholder="{{ __('admin.salary') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName9">{{ __('admin.bonus') }}</label>
                                        <input type="number" class="form-control" id="exampleInputName9" name="bonus" placeholder="{{ __('admin.bonus') }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-froup row">
                                          <div class="col-sm-6">
                                            <div class="form-check">
                                              <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="emp_type" id="exampleInputName10" value="Permanent" checked="true"> {{__('admin.permanent')}} <i class="input-helper"></i></label>
                                            </div>
                                          </div>
                                          <div class="col-sm-6">
                                            <div class="form-check">
                                              <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="emp_type" id="exampleInputName11" value="Contractual"> {{__('admin.contractual')}} <i class="input-helper"></i></label>
                                            </div>
                                          </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="exampleInputName12" name="joining" placeholder="{{ __('admin.joining') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName13">{{ __('admin.closing') }}</label>
                                        <input type="date" class="form-control" id="exampleInputName13" name="closing" placeholder="{{ __('admin.closing') }}">
                                    </div>
