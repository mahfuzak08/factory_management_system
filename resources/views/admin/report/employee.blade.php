            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                              <form action="{{route('salary-report')}}" method="GET">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">{{__('admin.name')}}</label>
                                            <div class="col-sm-9">
                                      ...
                                      @if(count($datas) > 0)
                                        ...
                                        @foreach($datas as $row)
                                          <tr>
                                            ...
                                            <td><a href="{{route('expense-invoice', $row->id)}}">{{$row->employees_name}}</a></td>
                                            <td>
                                              {{$row->amount}}
                                              @php 
